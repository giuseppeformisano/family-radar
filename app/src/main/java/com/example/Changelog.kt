...
object Changelog {
    ...
    const val VERSION = "0.20.0-beta"

    /** Poche righe, corte. Una per novita'/fix. */
    val LINES = listOf(
        "✨ Scia sulla mappa: dietro chi si muove appare una linea con il percorso degli ultimi minuti, cosi' vedi da dove e' passato e non solo dov'e' ora."
    )
}
